...
Route::get('/editDataDinas/{id}','LaporanDinasController@edit')->name('editDataDinas.edit');
Route::post('/editDataDinas/{id}','LaporanDinasController@update')->name('editDataDinas.update');
Route::delete('/lihatlaporanDinas/{id}','LaporanDinasController@destroy')->name('laporanDinas.destroy');
